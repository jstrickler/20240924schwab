...
with sqlite3.connect("../DATA/presidents.db") as s3conn:
    ...
    for fields in RESTORE_DATA:
        s3cursor.execute(PARTY_UPDATE, fields)  # second argument to execute() is iterable of values to fill in placeholders from left to right
